...
vim.keymap.set("n", "<leader>f", function()
    builtin.find_files({
        find_command = { "fd", "--type", "f", "-E", "node_modules", "-E", "build", "-E", "dist", "-E", "target", "-E", ".local", "-E", ".cache", "." }
    })
end)
vim.keymap.set("n", "<leader>t;", function()
    builtin.find_files({
        find_command = { "fd", "--hidden", "-E", ".local", "-E", ".cache", "-E", "node_modules", "-E", "build", "-E", "dist", "-E", "target", "--glob", "*.git", "." }
    })
end)
